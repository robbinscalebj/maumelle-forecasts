# Code from : https://github.com/eco4cast/gefs4cast
# Authored by Carl Boettiger and R Quinn Thomas. Adapted here, if at all, by Caleb Robbins
...
gefs_metadata <- function() {
    readr::read_csv(here("getGEFS_scripts/gefs-selected-bands.csv"),show_col_types = FALSE)
}
